...
class Article(models.Model):
    author  = models.ForeignKey("auth.User" , on_delete = models.CASCADE, verbose_name = "Yazar") # Parametre belirliyoruz
    title   = models.CharField(max_length = 50 , verbose_name = "Başlık ") # Menülemizi Türkçeleştirmek için ++ verbose_name ++
